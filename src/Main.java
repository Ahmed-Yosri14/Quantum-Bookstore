...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            double paid = inventory.buyBook("001", customer1);
        ...
        try {
            double paid = inventory.buyBook("001", customer2);
        ...
        try {
            double paid = inventory.buyBook("002", customer3);
        ...
        try {
            double paid = inventory.buyBook("002", customer4);
        ...
        try {
            double paid = inventory.buyBook("003", customer1);
